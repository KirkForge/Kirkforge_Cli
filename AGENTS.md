...
This project is indexed by GitNexus as **Kirkforge_Cli** (16980 symbols, 42918 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
