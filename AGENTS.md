...
This project is indexed by GitNexus as **Kirkforge_Cli** (1872 symbols, 4557 relationships, 163 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
