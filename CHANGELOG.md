...
- WO 41.4: verifier capability discovery UI (`/verify-capabilities`) + PASS security-only distinction in pipeline summary — [41.4](docs/workorders/41.4-verifier-capability-discovery.md)
