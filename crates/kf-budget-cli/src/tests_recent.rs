...
// (kf-budget-cli) rather than kf-budget-core because the writer and
...
// `$XDG_DATA_HOME/kf-budget/recent_outputs.jsonl` out of the
// test's blast radius.
use super::*;
...
// load, mirroring `aggregate_sessions` in kf-budget-core::report.
