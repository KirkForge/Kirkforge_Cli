//! Aggregator for `kf-budget report`. ADR-0010 § Report subcommand.
//!
//! ponytail: the aggregator moved from kf-budget-cli to kf-budget-core
...
/// `kf-budget report` prints. ADR-0010 § Report subcommand shows
...
///
/// ponytail: pinned here (not in kf-budget-cli) so a format drift
