...
use kf_draw_core::{DrawObject, InkColor};
...
fn ctrl_alt_t_wraps_from_underline_to_none() {
    ...
    let order = [
        kf_draw_core::TextBorderMode::Single,
        kf_draw_core::TextBorderMode::Double,
        kf_draw_core::TextBorderMode::Underline,
        kf_draw_core::TextBorderMode::None,
    ];
...
fn lower_i_advances_single_selected_box_color() {
    ...
    // white to red).
    use kf_draw_core::{BoxObject, BoxStyle, DrawObject, InkColor};
    let mut app = make_app();
