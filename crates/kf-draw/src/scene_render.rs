...
fn ink_style(c: Option<kf_draw_core::InkColor>) -> Style {
    Style::default().fg(match c {
        Some(kf_draw_core::InkColor::White) => Color::White,
        Some(kf_draw_core::InkColor::Red) => Color::Red,
        Some(kf_draw_core::InkColor::Orange) => Color::Indexed(208),
        Some(kf_draw_core::InkColor::Yellow) => Color::Yellow,
        Some(kf_draw_core::InkColor::Green) => Color::Green,
        Some(kf_draw_core::InkColor::Cyan) => Color::Cyan,
        Some(kf_draw_core::InkColor::Blue) => Color::Blue,
        Some(kf_draw_core::InkColor::Magenta) => Color::Magenta,
        None => Color::Reset,
    })
}
...
fn project_to_viewport(
    doc_point: kf_draw_core::Point,
    scene_origin: kf_draw_core::Point,
    viewport: Rect,
    scroll_x: i32,
    scroll_y: i32,
) -> Option<(u16, u16)> {
...
mod tests {
    use super::*;
    use kf_draw_core::types::{BoxObject, BoxStyle, InkColor};
    use kf_draw_core::{compose_scene, create_scene, types::DrawObject};
    use kf_draw_core::{Point, Rect as KRect};
    use ratatui::layout::Rect;
