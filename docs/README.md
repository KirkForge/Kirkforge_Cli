docs/
  ...
  coverage-baseline.md          — Per-crate line coverage baselines (coverage gate)
  com.kirkforge.daemon.plist    — macOS launchd daemon plist
  kirkforge-daemon.service      — Linux systemd service unit