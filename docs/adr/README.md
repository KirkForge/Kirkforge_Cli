...
| [0032](./0032-tool-retry-backoff.md) | Exponential backoff on tool-call retries | Accepted |
...
- [ADR-032: Exponential backoff on tool-call retries](./0032-tool-retry-backoff.md)
