...
- **CLI** — 3-digit numbers (`001`–`073`). Native KirkForge-Cli ADRs covering
...
| [0029](./0029-test-partitioning.md) | Test partitioning — fast / full / coverage suites | Accepted (per-test timings + flaky-test detection shipped, WO 12.5; smart suggest + apply shipped, WO 12.6) | Plugin3 |
