...
- [ADR-028: Unify Rust and TypeScript verifier buses](./0028-verifier-bus-unification.md)
- [ADR-030: Build and test verifier slots](./0030-build-test-verifier-slots.md)
