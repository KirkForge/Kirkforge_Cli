...
### Series 42 — Security hardening follow-ups

Targeted closures of attack vectors surfaced by the audit. Each item is
small, test-covered, and gated by the standard CI matrix.
