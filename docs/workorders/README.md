...
| 41.1 | [Apply coder patch + rename ParallelOrchestrator](41.1-patch-application.md) | Done |
| 41.2 | [Handoff delimiter spoof test + escaping](41.2-handoff-delimiter-spoof.md) | Done |
| 41.3 | [Permission docs fix (undersell → accurate)](41.3-permission-docs.md) | Done |
| 41.4 | [Verifier capability discovery UI](41.4-verifier-capability-discovery.md) | Done |
| 41.5 | [Persistent subagent lifecycle](41.5-persistent-subagent.md) | Phase 1 Done |
