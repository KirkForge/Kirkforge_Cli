...
use kf_plugin_host::sdk::{Capability, Plugin};
...
mod loader_tests {
    ...
    fn trust_policy_from_config_maps_all_fields() {
        ...
        cfg.tools.max_plugin_trust = kf_plugin_host::sdk::TrustTier::Network;
        ...
        let policy = trust_policy_from_config(&cfg);
        assert_eq!(policy.max, kf_plugin_host::sdk::TrustTier::Network);
    ...
    fn local_trust_policy_default_enforces_signatures() {
        ...
        let base = TrustPolicy {
            max: kf_plugin_host::sdk::TrustTier::Shell,
