...
// Mini handlebars-subset template renderer lives in `template.rs` (WO 45.19).
// See the `ponytail:` ceiling there for the supported construct subset.
...
mod tests {
    ...
    // Renderer tests (test_template_construct_freeze, test_render_template_*,
    // test_render_matches_handlebars_reference*) moved to template.rs (WO 45.19).
}
